...
impl DeliveryAccount {
        ...
        N: Into<Option<String>>,
    {
        ...
        self.client.get_signed_d("/dapi/v1/order", &request).await
    }
    ...
    pub async fn position_information(&self, symbol: Option<String>) -> Result<Vec<Position>> {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .get_signed_d("/dapi/v1/positionRisk", &request).await
    }
    ...
    pub async fn account_income(&self, start_time: Option<i64>, end_time: Option<i64>, limit: Option<u16>) -> Result<Vec<AccountIncome>> {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client.get_signed_d("/dapi/v1/income", request.as_str()).await
    }
        ...
        S: Into<String>,
    {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client.post_signed_d("/dapi/v1/leverage", request.as_str()).await
    }
